...
class MPService {
    ...
    private let d: [String: Int] = ["3rd": 800,
                            "4th": 900,
                            "Easy 5th": 950,
                            "5.0": 1000,
                            "5.1": 1100,
    ...
    private func get14s(x: Int) -> (Int?, Int?) {
        switch x {
        case 10500:
            return (14, 0)
        case 10600...10900:
    ...
    private func get15s(x: Int) -> (Int?, Int?) {
        switch x {
        case 11600:
            return (15, 0)
        case 11700...11900:
    ...
    public func stringToRating(rating: String) -> (Int?, Int?) {
        guard let first = Array(rating.split(separator: " ")).first else { return (nil, nil) }
